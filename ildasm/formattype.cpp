...
char* ProperName(char* name)
{
	...
	if(name)
	{
		if(*name)
		{
			pcn = name;
			pcb = buff;
			if(IsNameToQuote(name)) *pcb++ = '\'';
			do {
				switch(*pcn)
				{
					case '\t': *pcb++ = '\\'; *pcb++ = 't'; break;
					case '\n': *pcb++ = '\\'; *pcb++ = 'n'; break;
					case '\b': *pcb++ = '\\'; *pcb++ = 'b'; break;
					case '\r': *pcb++ = '\\'; *pcb++ = 'r'; break;
					case '\f': *pcb++ = '\\'; *pcb++ = 'f'; break;
					case '\v': *pcb++ = '\\'; *pcb++ = 'v'; break;
					case '\a': *pcb++ = '\\'; *pcb++ = 'a'; break;
					case '\\': *pcb++ = '\\'; *pcb++ = '\\'; break;
					case '\'': *pcb++ = '\\'; *pcb++ = '\''; break;
					case '\"': *pcb++ = '\\'; *pcb++ = '\"'; break;
					default: *pcb++ = *pcn;
