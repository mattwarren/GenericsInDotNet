...
#else
LPCWSTR MDInternalRO::GetUserStringRequiresSwap( // Offset into the string blob heap.
#endif
    ...
    MDDefaultValue  *pMDDefaultValue)
{
    ...
    case ELEMENT_TYPE_STRING:
#if BIGENDIAN
        {
            ...
            pMDDefaultValue->m_wzValue = (WCHAR *)malloc(cbValue);
            IfNullGo(pMDDefaultValue->m_wzValue);
            memcpy(pMDDefaultValue->m_wzValue, pValue, cbValue);
            _ASSERTE(cbValue % sizeof(WCHAR) == 0);
            SwapStringLength(pMDDefaultValue->m_wzValue, cbValue / sizeof(WCHAR));
        }
#else
    ...
    case ELEMENT_TYPE_CLASS:
        ...
        _ASSERTE(pMDDefaultValue->m_unkValue == NULL);
        break;  
    case ELEMENT_TYPE_I8:
