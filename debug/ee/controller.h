...
public:
    ...
    // CONTEXT* pContext:  A pointer to a CONTEXT structure.  CANNOT be
    //      NULL
    // BOOL contextValid:  True if the pContext arg points to a valid
...
// patch's lifetime.
//
// FREEHASHENTRY entry:  Three USHORTs, this is required
...
//#endif //_DEBUG            
	...
	// GetPatch will find the first  patch in the hash table 
	...
	// GetPatch will translate MethodDesc into {Module,mdMethodDef},
	//		and find the first  patch in the hash table that is hashed by
	//		matching DebuggerFunctionKey.  This will NOT find anything
...
private:
    ...
    DebuggerJitInfo *       m_djiVersion; //This can be NULL 
