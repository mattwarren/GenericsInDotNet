...
//  SIZE_T ilOffsetOld:  Old IL offset
//  SIZE_T ilOffsetNew:  The new IL offset corrsponding to the old.
//  BOOL fAccurate:
...
public:
    ...
    // MapOldILToNew takes an oldIL, and does a binary search on the
    //      DebuggerOldILToNewILMap map, and
...
// FREEHASHENTRY entry:  Needed for use by the hash table
// DebuggerJitInfo *ji:  The actual DebuggerJitInfo to
//          hash.  Note that DJI's will be hashed by MethodDesc.
