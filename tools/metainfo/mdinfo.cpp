...
void MDInfo::DisplayCustomAttributeInfo(mdCustomAttribute inValue, const char *preFix)
{
    ...
    // Get the name of the memberref or methoddef.
        ...
        {
            int iLen;
            LPWSTR pwzName = (LPWSTR)_alloca(sizeof(WCHAR)*(iLen= 1+(ULONG32)strlen(pMethName)));
...
LPWSTR MDInfo::VariantAsString(VARIANT *pVariant)
{
    ...
    else if (hr == DISP_E_BADVARTYPE && V_VT(pVariant) == VT_I8)
    {
        ...
        sprintf(szStr, "%I64d", V_CY(pVariant).int64);
        // Convert to unicode.
    ...
    VARIANT     *pvar) 
{
    ...
    case ELEMENT_TYPE_CLASS:
        ...
        V_UNKNOWN(pvar) = NULL;
        _ASSERTE( (IUnknown *)GET_UNALIGNED_32(pValue) == NULL);
        break;
    case ELEMENT_TYPE_I8:
        V_VT(pvar) = VT_I8;
